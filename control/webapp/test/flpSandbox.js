		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "control",
									"targetURL": "#logaligroupcontrol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupcontrol-display": {
								"semanticObject": "logaligroupcontrol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.control",
									"url": sap.ui.require.toUrl("logaligroup/control")
								}
							}
						}
					}
